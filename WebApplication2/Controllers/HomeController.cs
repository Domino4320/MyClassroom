    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> UploadAvatar(IFormFile Avatar)
        {
            ...
            if (user != null)
            {
                ...
                // 3. РћР‘РќРћР’Р›Р•РќРР• РЎР•РЎРЎРР + РџР РРќРЈР”РРўР•Р›Р¬РќР«Р™ COMMIT
                HttpContext.Session.SetString("Avatar", newAvatarPath);
                // Р­С‚Рѕ РіР°СЂР°РЅС‚РёСЂСѓРµС‚, С‡С‚Рѕ СЃРµСЃСЃРёСЏ Р·Р°РїРёС€РµС‚СЃСЏ РІ С…СЂР°РЅРёР»РёС‰Рµ Р”Рћ С‚РѕРіРѕ, РєР°Рє РІРµСЂРЅРµС‚СЃСЏ JSON РѕС‚РІРµС‚
